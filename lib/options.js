...
module.exports = function () {
  if (_.isUndefined(options)) {
    options = program
      ...
      .option('-g, --geolimit <limit>', 'Limit to given coordinates, in format "lon1:lat1:lon2:lat2", like "13.0:55.0:24.0:46.0"')
    ...
    program.geolimit = program.geolimit ? program.geolimit : '';
